...
class GridScreenCreateCommand extends CreateCommand with CommandHelper {
  GridScreenCreateCommand(this.directoryStructor, this.moduleName, this.moduleCreated);
      ...
      if (directoryStructor == DirectoryStructor.modular) {
        ...
        await Future.wait([
          writeFile(
            ...
            content: CreateScreenGenerator.gridScreenControllerFileContent,
            screenName: screenName,
          ),
          writeFile(
            path: "${Constants.modulesDirectoryPath}/$moduleName/$screenName/view/$screenName.dart",
            content: CreateScreenGeneratorModular.gridScreenFileContent,
            screenName: screenName,
          ),
          writeFile(
            path: "${Constants.modulesDirectoryPath}/$moduleName/$screenName/view/grid_list_item_view.dart",
            content: CreateScreenGenerator.gridListItemFileContent,
            screenName: screenName,
          ),
          writeFile(
            path: "${Constants.modulesDirectoryPath}/$moduleName/$screenName/view/loading_view.dart",
            content: CreateScreenGenerator.gridLoadingViewFileContent,
            screenName: screenName,
          ),
          writeFile(
        ...
        await Future.wait([
          ...
          writeFile(
            ...
            content: CreateScreenGeneratorGlobal.gridScreenFileContent,
            screenName: screenName,
          ),
          writeFile(
            path: "${Constants.screensDirectoryPath}/$screenName/view/grid_list_item_view.dart",
            content: CreateScreenGenerator.gridListItemFileContent,
            screenName: screenName,
          ),
          writeFile(
...
│   │   │   │   │   ├── grid_list_item_view.dart  ✨ (ADDED)
